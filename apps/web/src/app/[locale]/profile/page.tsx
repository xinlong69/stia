  ...
  return (
    <main className="min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 overflow-x-hidden selection:bg-orange-600/30 transition-colors duration-200 flex flex-col justify-between">
      <div className="w-full">
        <Header />
        <div className="min-h-screen bg-[#13131a] text-zinc-100 p-4 md:p-8 flex justify-center items-start">
          <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-4 gap-6">
            
            {/* ================= LEFT SIDEBAR: PROFILE CARD ================= */}
            <aside className="lg:col-span-1 bg-[#1c1c24] border border-zinc-800/50 rounded-2xl p-6 flex flex-col items-center text-center">
